...
momentumErrorPlotFlag     = true;
posturalTaskErrorPlotFlag = true;
vLyapunovFunctionPlotFlag = true;
alphaProjectionPlotsFlag  = true;
measuredToruquePlotsFlag  = true;
legsPowerPlotsFlag        = true;
...
if (comErrorPlotFlag)
    ...
    comErrorPlots(time, timeIndexes, comMes, comDes, range, lineWidth,...
                  verticleLineWidth, fontSize, legendFontSize, axesLineWidth,...
                  axesFontSize, xLabelFontSize, yLabelFontSize, titleFontSize,...
